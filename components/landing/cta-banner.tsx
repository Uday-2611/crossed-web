    ...
    return (
        <section className="py-24">
            <div className="mx-auto px-6">
                <motion.div
                    className="relative overflow-hidden rounded-md bg-neutral-100 px-16 py-12 text-center sm:px-12 sm:py-24 flex w-[80vw] mx-auto"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                >
                    <div className="z-10 mx-auto max-w-2xl flex flex-row gap-20">
